...
from stargrep.matcher import search_file
from stargrep.walker import walk_paths
from stargrep.output import highlight_match, format_line, print_separator
...
def main():
    ...
    for file_path in walk_paths(args.paths, args.recursive):
        ...
        if args.count:
            ...
            if use_color:
                from stargrep.output import COLOR_FILENAME, COLOR_RESET
